...
>Please refer to [*Conceptual Model*](./conceptual_model.md) to learn about the benefits and specifics of each of the types
...
>If the user chooses to define the size above ***8 KByte***, the database will consume more memory for the metadata of each entry in order to be able to deal with the bigger RAM space.
